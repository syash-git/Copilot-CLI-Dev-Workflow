...
You walk into your new team on Monday morning, excited and nervous. After a quick coffee and introductions, your team lead pulls up a chair:

> *"Welcome aboard! We have a small project called the book app—it's a Python CLI that manages a book collection. It's got decent code, but it's never been thoroughly reviewed, tested, or debugged in production. We need it ready to ship today. I know it's a lot, but here's the thing: you're going to use this exact workflow to solve real problems on our team every day. And I'm going to introduce you to a tool that makes you 10x faster: the Copilot CLI."*

Your heart skips. One hour? But then your lead smiles:

> *"Don't worry. You're not doing this alone. The Copilot CLI is like having a senior engineer pair with you—it asks the right questions, spots things you'd miss, and generates code that actually works. Today, we're going to walk through four workflows that you'll repeat constantly: reviewing inherited code, fixing problems before they ship, writing tests that actually matter, and debugging under pressure. By lunch, you'll have done all four."*

You sit down at your desk, grab your laptop, and open the terminal. Your lead slides a guide across the desk with a wink:
...
**Without AI**: Spend 30+ minutes reading code, making notes, trying to understand dependencies.
